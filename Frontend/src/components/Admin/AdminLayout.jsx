        ...
        <div className="fixed inset-0 flex z-40">
          ...
          <div className="relative flex-1 flex flex-col max-w-xs w-full bg-white">
            ...
            <div className="flex-shrink-0 border-t border-gray-200">
              ...
              <Link
                to="/"
                className="flex items-center px-4 py-3 text-blue-600 hover:bg-blue-50 hover:text-blue-700 border-b border-gray-200"
                onClick={() => setSidebarOpen(false)}
              >
                <FiArrowLeft className="mr-3 h-5 w-5 text-blue-600" />
        ...
        <div className="flex-1 flex flex-col min-h-0 border-r border-gray-200 bg-white">
          ...
          <div className="flex-shrink-0 border-t border-gray-200">
            ...
            <Link
              ...
              className="flex items-center px-4 py-3 text-blue-600 hover:bg-blue-50 hover:text-blue-700 border-b border-gray-200"
            >
              <FiArrowLeft className="mr-3 h-4 w-4 text-blue-600" />
              <span className="text-sm font-medium">Back to Shop</span>
            </Link>
